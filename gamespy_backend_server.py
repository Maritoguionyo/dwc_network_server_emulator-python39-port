...
class GameSpyBackendServer(object):
    ...
    def start(self):
        ...
        manager = GameSpyServerDatabase(address=address_tuple,
    ...
    def find_servers(self, gameid, filters, fields, max_count):
        matched_servers = []
        #self.server_list = [{gameid}]    #force add mkwii test
        #self.server_list["gameid"] = {gameid}
        #self.server_list.append({"gameid": {gameid}}) #force adding gameid test
